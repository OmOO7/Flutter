...
abstract class Processor{
  ...
  static Stream _stream = _controller.stream;
  ...
  static String get _equation => _valA + (_operator != null? ''+ _operator.value:'') + (_valB != '0' ? ' ' + _valB: '');
  ...
  static void handlerInteger(CalculatorKey key){
